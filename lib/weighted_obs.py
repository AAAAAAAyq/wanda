...
class WeightedOBS:
    def __init__(self, layer, weighted_obs):
        self.layer = layer
        ...
        self.weighted_obs = weighted_obs
        print(self.weighted_obs.shape)
    ...
    def add_batch(self, inp, out):
        ...
        self.H += inp.matmul(self.weighted_obs).matmul(inp.t()) # weighted L2
...
#     def fasterprune(
#         self, sparsity, weighted_obs, prune_n=0, prune_m=0, blocksize=128, percdamp=.01
#     ):
#         W = self.layer.weight.data.clone()
#         if isinstance(self.layer, nn.Conv2d):
#             W = W.flatten(1)
